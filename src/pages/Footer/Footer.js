...
function Footer() {
  return (
       ...
       <div className='Cir'>
       <img src={Logo}  className='logoimg'></img></div> 
       {/* <Marqueee/> */}
       <div className='Style11'>
        ...
        <div className='footer-logo-sm rowfootor-logo'>
          <div className='footer-logo colfootor-logo'>
            <a href="https://www.instagram.com/1clickcapital/"><img src={Instagram}  className='sm-logo'/></a>
          </div>
          <div className='footer-logo colfootor-logo'>
            <a href=" https://www.facebook.com/1clickcapital"><img src={Facebook}  className='sm-logo'/></a>
          </div>
          <div className='footer-logo colfootor-logo'>
            <a href="https://www.linkedin.com/company/1-click-capital/mycompany/"><img src={LinkedIn}  className='sm-logo'/></a>
          </div>
          <div className='footer-logo colfootor-logo'>
            <a href='https://twitter.com/1clickcapital'><img src={Twitter}  className='sm-logo'/></a>
          </div>
        </div>
